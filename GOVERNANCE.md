...
This document describes how @sebastienrousseau/tailwindcss-config is run: who decides what, how
...
@sebastienrousseau/tailwindcss-config is **maintainer-led**. As of the current release line it has a single
