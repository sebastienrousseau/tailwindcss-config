...
# Packaging @sebastienrousseau/tailwindcss-config
...
-  `tailwind.config.js` — the tool-native preset file(s)
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/tailwindcss-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/tailwindcss-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/tailwindcss-config/` |
| Homebrew | [`pkg/brew/tailwindcss-config.rb`](../pkg/brew/tailwindcss-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/tailwindcss-config/` |
